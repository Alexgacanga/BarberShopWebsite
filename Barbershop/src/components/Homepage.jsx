...
export const Homepage = () => {
  ...
  return (
    <div>
      ...
      <section id="about">
        <section>
          <div className="pt-30 mt-10 md:mb-20 md:mt-30">
            <h1 className="text-center m-auto font-poppins sm:text-4xl md:text-5xl text-3xl font-bold">
              OUR STORY
            </h1>
          </div>
        </section>
        <section className="bg-white md:mb-20 lg:mb-25">
          <div className="flex-col sm:flex sm:flex-row content-center m-8">
            <div className="md:basis-1/2">
              <img
                className="lg:w-120 md:w-80 w-70 m-auto rounded-xl border-3 border-b-black h-full"
                src={pic1}
                alt="Barber Pic"
                loading="lazy"
              />
            ...
            <div className="mt-9 text-center md:text-xs lg:text-xl text-xs w-60  content-center font-poppins m-auto md:basis-1/2 md:w-full p-">
              <p>
                <span className="text-2xl md:text-4xl sm:text-3xl font-bold text-center">
                  <span className="text-blue-700">Sharp. </span>
                ...
                <span className="italic">
                  "Urban Trims sits at the intersection of street style and
                  professional grooming. I started this journey because I saw a
                  gap between the traditional barbering of the past and the
                  evolving style needs of today. With a focus on modern
                  techniques and architectural precision, my goal is to help you
                  cultivate a look that is distinctly yours. From skin fades to
                  beard sculpting, I treat every cut as a collaborative project.
                  I stay ahead of the trends so you don't have to, ensuring that
                  when you walk out of our doors, you look as sharp as you feel.
                  This isn't just a haircut; it's an upgrade to your personal
                  brand."
                </span>
              </p>
            </div>
      ...
      <div
        id="gallery"
        className="pt-25 w-full bg-gradient-to-b from-slate-50 to-slate-100 py-16 overflow-hidden"
      >
      ...
      <section
        ...
        id="contact"
        className="pt-25 md:pt-30 w-full bg-gray-50 py-16 px-4 sm:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-white max-w-xl">
              We're here to help you find your personal style and tailor our
              services to your vision . Reach out to book your spot or drop by
      ...
      <footer class="bg-gray-100">
        <div class="mx-auto max-w-5xl px-4 pb-5 pt-16 sm:px-6 lg:px-8">
          ...
          <div>
            <p className="text-center pt-5 pb-0 mb-0 text-gray-700">
              &copy; 2026 by Alex Mwangi, Software Engineer
            </p>
          </div>
        </div>
      </footer>

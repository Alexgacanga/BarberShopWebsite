      ...
      {isOpen && (
        <div className="md:hidden bg-gray-500 pb-6 px-4 pt-2 shadow-lg">
          <ul className="flex flex-col space-y-4">
            {list.map((item, index) => (
              <li key={index} className="font-poppins font-bold text-lg border-b border-gray-400 pb-2">
                <a
                  href={item.link}
          ...
          <div className="mt-6 flex flex-col gap-4">
             <a href="/" className="font-bold text-amber-600 hover:text-amber-500 transition">
                Login
             </a>
             <div className="flex gap-4 mt-2">
                {/* Re-using Social Icons here for Mobile visibility */}
                 {/* Instagram */}
                 <a href="/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-amber-600 transition">
